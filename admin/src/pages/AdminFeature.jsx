        ...
        <div className="p-6 max-w-6xl mx-auto fade-in">
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6 scale-in">
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="bg-gray-200 p-6 rounded-lg border border-gray-200 card-hover">
                        <h2 className="text-xl font-semibold text-gray-800 mb-4 flex items-center gap-2">
                            <FaPalette className="text-yellow-600" />
                            Cores da Seção Principal
                        </h2>
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        />
                                        <div>
                                            <p className="font-medium">{featuresData.backgroundColor}</p>
                                            <button
                                                type="button"
                                                onClick={() => openColorPicker('background')}
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="flex items-center gap-3">
                                        <div 
                                            className="w-12 h-12 rounded-lg border-2 border-gray-300 cursor-pointer hover:scale-105 transition-transform"
                                            style={{ backgroundColor: featuresData.titleColor }}
                                            onClick={() => openColorPicker('title')}
                                        />
                                        <div>
                                            <p className="font-medium">{featuresData.titleColor}</p>
                                            <button
                                                type="button"
                                                onClick={() => openColorPicker('title')}
                                                className="text-blue-600 hover:text-blue-700 text-sm"
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="flex items-center gap-3">
                                        <div 
                                            className="w-12 h-12 rounded-lg border-2 border-gray-300 cursor-pointer hover:scale-105 transition-transform"
                                            style={{ backgroundColor: featuresData.subtitleColor }}
                                            onClick={() => openColorPicker('subtitle')}
                                        />
                                        <div>
                                            <p className="font-medium">{featuresData.subtitleColor}</p>
                                            <button
                                                type="button"
                                                onClick={() => openColorPicker('subtitle')}
                                                className="text-blue-600 hover:text-blue-700 text-sm"
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="flex items-center gap-3">
                                        <div 
                                            className="w-12 h-12 rounded-lg border-2 border-gray-300 cursor-pointer hover:scale-105 transition-transform"
                                            style={{ backgroundColor: featuresData.cardBackgroundColor }}
                                            onClick={() => openColorPicker('cardBackground')}
                                        />
                                        <div>
                                            <p className="font-medium">{featuresData.cardBackgroundColor}</p>
                                            <button
                                                type="button"
                                                onClick={() => openColorPicker('cardBackground')}
                                                className="text-blue-600 hover:text-blue-700 text-sm"
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="flex items-center gap-3">
                                        <div 
                                            className="w-12 h-12 rounded-lg border-2 border-gray-300 cursor-pointer hover:scale-105 transition-transform"
                                            style={{ backgroundColor: featuresData.cardTitleColor }}
                                            onClick={() => openColorPicker('cardTitle')}
                                        />
                                        <div>
                                            <p className="font-medium">{featuresData.cardTitleColor}</p>
                                            <button
                                                type="button"
                                                onClick={() => openColorPicker('cardTitle')}
                                                className="text-blue-600 hover:text-blue-700 text-sm"
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="flex items-center gap-3">
                                        <div 
                                            className="w-12 h-12 rounded-lg border-2 border-gray-300 cursor-pointer hover:scale-105 transition-transform"
                                            style={{ backgroundColor: featuresData.cardTextColor }}
                                            onClick={() => openColorPicker('cardText')}
                                        />
                                        <div>
                                            <p className="font-medium">{featuresData.cardTextColor}</p>
                                            <button
                                                type="button"
                                                onClick={() => openColorPicker('cardText')}
                                                className="text-blue-600 hover:text-blue-700 text-sm"
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="flex items-center gap-3">
                                        <div 
                                            className="w-12 h-12 rounded-lg border-2 border-gray-300 cursor-pointer hover:scale-105 transition-transform"
                                            style={{ backgroundColor: featuresData.iconColor }}
                                            onClick={() => openColorPicker('icon')}
                                        />
                                        <div>
                                            <p className="font-medium">{featuresData.iconColor}</p>
                                            <button
                                                type="button"
                                                onClick={() => openColorPicker('icon')}
                                                className="text-blue-600 hover:text-blue-700 text-sm"
