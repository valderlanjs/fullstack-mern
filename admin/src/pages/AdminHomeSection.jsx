                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value={homeData.highlightedText || ""}
                                    onChange={handleInputChange}
                                    className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary focus:border-transparent transition-all duration-200"
                            ...
                            <div className="flex items-center gap-4">
                                <div className="flex items-center gap-3">
                                    <div 
                                        ...
                                        style={{ backgroundColor: homeData.backgroundColor }}
                                        onClick={() => openColorPicker('background')}
                                    />
                                    <div>
                                        <p className="font-medium">{homeData.backgroundColor}</p>
                                        <button
                                            type="button"
                                            onClick={() => openColorPicker('background')}
                        ...
                        <div className="mb-6">
                            ...
                            <div className="flex items-center gap-4">
                                <div className="flex items-center gap-3">
                                    <div 
                                        className="w-12 h-12 rounded-lg border-2 border-gray-300 cursor-pointer hover:scale-105 transition-transform"
                                        style={{ backgroundColor: homeData.textColor }}
                                        onClick={() => openColorPicker('text')}
                                    />
                                    <div>
                                        <p className="font-medium">{homeData.textColor}</p>
                                        <button
                                            type="button"
                                            onClick={() => openColorPicker('text')}
                                            className="text-blue-600 hover:text-blue-700 text-sm"
                        ...
                        <div className="mb-6">
                            ...
                            <div className="flex items-center gap-4">
                                <div className="flex items-center gap-3">
                                    <div 
                                        className="w-12 h-12 rounded-lg border-2 border-gray-300 cursor-pointer hover:scale-105 transition-transform"
                                        style={{ backgroundColor: homeData.highlightColor }}
                                        onClick={() => openColorPicker('highlight')}
                                    />
                                    <div>
                                        <p className="font-medium">{homeData.highlightColor}</p>
                                        <button
                                            type="button"
                                            onClick={() => openColorPicker('highlight')}
                                            className="text-blue-600 hover:text-blue-700 text-sm"
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        />
                                        <div>
                                            <p className="font-medium">{homeData.buttonColor}</p>
                                            <button
                                                type="button"
                                                onClick={() => openColorPicker('button')}
                                                className="text-blue-600 hover:text-blue-700 text-sm"
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="flex items-center gap-3">
                                        <div 
                                            className="w-12 h-12 rounded-lg border-2 border-gray-300 cursor-pointer hover:scale-105 transition-transform"
                                            style={{ backgroundColor: homeData.buttonTextColor }}
                                            onClick={() => openColorPicker('buttonText')}
                                        />
                                        <div>
                                            <p className="font-medium">{homeData.buttonTextColor}</p>
                                            <button
                                                type="button"
                                                onClick={() => openColorPicker('buttonText')}
                                                className="text-blue-600 hover:text-blue-700 text-sm"
