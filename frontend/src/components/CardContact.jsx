...
const CardContact = ({ vendor }) => {
  return (
    <div className="flex-col flex items-center  bg-white  lg:h-[340px] lg:w-[210px] h-[280px] w-[160px] border border-gray-200 rounded-lg p-1 overflow-hidden hover:border-[#00801A] duration-200 cursor-pointer">
      ...
      <h3 className="text-lg text-black font-semibold">{vendor.name}</h3>
      <p className="font-bold text-black lg:text-[10px] text-[9px] w-full flex mb-2 justify-center">
        {vendor.email}
      </p>
      {vendor.whatsapp && (
        <a
