      ...
      >
        <div className="w-2/4 max-md:w-full ">
          ...
          >
            ...
            Fale com nossos <span className="text-secondary">vendedores</span> e solicite um <span className="text-secondary">orçamento</span>
          </h2>
          </motion.div>
        </div>
        <div className="w-2/4 max-md:w-full">
        ...
        <motion.div
          ...
          id="vendedores"
        >
          <h2 className="h1 absolute mt-5 mb-14 font-extralight text-center">Nossa equipe de vendedores</h2>
        </motion.div>
        ...
        <iframe
          style={{ border: 0, borderRadius: "10px", display: "block", margin: "auto", marginBottom: "40px"}}
          width="80%"
          height="450"
          loading="lazy"
          allowfullscreen
